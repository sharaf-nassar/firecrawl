...
- [[local-extract]] — Opt-in local extract, JSON scrape, shim failure, restart, and DLQ contracts.
- [[runtime-operations]] — Browser and support runtimes, local orchestration tests, acceptance limits, and required CI scope.
- [[x402-settlement]] — Counter contracts for payment rejection, provider execution, controller mapping, and exactly-once settlement.
